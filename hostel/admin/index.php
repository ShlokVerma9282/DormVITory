...
<body>
	<div class="login-page bk-img" style="background-image: img/login-bg.jpg;">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 bk-primary" style="margin: 0; position: absolute; top: 50%; left:25%; -ms-transform: translateY(-50%); transform: translateY(-50%);">
						<h1 class="text-center text-bold text-light mt-1x"><b>DormVITory</b></h1>
